    ...
    <>
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-1'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
              ...
              whileInView = {{y:0,opacity:1}} 
              transition={{duration:0.6, delay:1}}  
              href="./manjunathk-resume.docx" download className='px-5 py-1 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>my resume
